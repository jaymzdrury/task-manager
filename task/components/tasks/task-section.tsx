    ...
    <Column
      ...
      settings={
        <span className={cn(styles.start, "space-x-4")}>
          <AddTask title={title} icon={<Plus size={30} />}>
            {users.map((user) => (
          ...
          <DeleteAllTask>
            <DeleteAllMenuLazy title={title} length={column?.length} />
          </DeleteAllTask>
        </span>
      }
    >
              ...
              <CardBody
                ...
                title={
                  <TaskCardEdit cardInfo={task} type="title">
                    <CardTitle itemProp="title" className={styles.ellipsis}>
                      {task.title}
                    </CardTitle>
                  </TaskCardEdit>
                }
                description={
                  <TaskCardEdit cardInfo={task} type="description">
                    <p itemProp="description" className={styles.ellipsis}>
                      {task.description}
                    </p>
                  </TaskCardEdit>
                }
